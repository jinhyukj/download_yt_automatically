...
TORGUARD_PROXIES = {
    # Torguard SOCKS5 IPs with HTTP bridge ports (9080-9129)
    # 50 working IPs across Canada and UK
    # Canada - Montreal (89.47.234.x)
    "tg-ca01": ("89.47.234.26", 9080), "tg-ca02": ("89.47.234.27", 9081),
    "tg-ca03": ("89.47.234.28", 9082), "tg-ca04": ("89.47.234.29", 9083),
    "tg-ca05": ("89.47.234.30", 9084), "tg-ca06": ("89.47.234.74", 9085),
    "tg-ca07": ("89.47.234.75", 9086), "tg-ca08": ("89.47.234.76", 9087),
    "tg-ca09": ("89.47.234.77", 9088), "tg-ca10": ("89.47.234.78", 9089),
    # Canada - Montreal (86.106.90.x)
    "tg-ca11": ("86.106.90.226", 9090), "tg-ca12": ("86.106.90.227", 9091),
    "tg-ca13": ("86.106.90.228", 9092), "tg-ca14": ("86.106.90.229", 9093),
    "tg-ca15": ("86.106.90.230", 9094),
    # Canada - Montreal (146.70.27.x)
    "tg-ca16": ("146.70.27.218", 9095), "tg-ca17": ("146.70.27.219", 9096),
    "tg-ca18": ("146.70.27.220", 9097), "tg-ca19": ("146.70.27.221", 9098),
    "tg-ca20": ("146.70.27.222", 9099), "tg-ca21": ("146.70.27.250", 9100),
    "tg-ca22": ("146.70.27.251", 9101), "tg-ca23": ("146.70.27.252", 9102),
    "tg-ca24": ("146.70.27.253", 9103), "tg-ca25": ("146.70.27.254", 9104),
    # Canada - Montreal (176.113.74.x)
    "tg-ca26": ("176.113.74.74", 9105), "tg-ca27": ("176.113.74.75", 9106),
    "tg-ca28": ("176.113.74.76", 9107), "tg-ca29": ("176.113.74.77", 9108),
    "tg-ca30": ("176.113.74.78", 9109), "tg-ca31": ("176.113.74.130", 9110),
    "tg-ca32": ("176.113.74.131", 9111), "tg-ca33": ("176.113.74.132", 9112),
    "tg-ca34": ("176.113.74.133", 9113), "tg-ca35": ("176.113.74.134", 9114),
    "tg-ca36": ("176.113.74.138", 9115), "tg-ca37": ("176.113.74.139", 9116),
    "tg-ca38": ("176.113.74.140", 9117), "tg-ca39": ("176.113.74.141", 9118),
    "tg-ca40": ("176.113.74.142", 9119),
    # UK - London (146.70.95.x)
    "tg-uk01": ("146.70.95.26", 9120), "tg-uk02": ("146.70.95.27", 9121),
    "tg-uk03": ("146.70.95.28", 9122), "tg-uk04": ("146.70.95.29", 9123),
    "tg-uk05": ("146.70.95.30", 9124), "tg-uk06": ("146.70.95.74", 9125),
    "tg-uk07": ("146.70.95.75", 9126), "tg-uk08": ("146.70.95.76", 9127),
    "tg-uk09": ("146.70.95.77", 9128), "tg-uk10": ("146.70.95.78", 9129),
}
